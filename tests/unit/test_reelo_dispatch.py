...
def test_dispatch_reloads_authoritative_state_before_adapter(monkeypatch, tmp_path):
    ...
    host = SimpleNamespace(HostConfig=lambda **kw: kw, NativeHost=lambda cfg: None)
