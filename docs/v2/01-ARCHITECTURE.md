...
Current implemented route: current-ledger Verified Insight → Content Opportunity → Topic → Angle → explicit human selection. Routers remain future architecture. Legacy runtime is unchanged.
