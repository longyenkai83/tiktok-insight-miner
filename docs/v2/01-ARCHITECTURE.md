...
Product Route is independent of Content Route. Full current-ledger human verification plus human priority_need gate precedes generation. JSON tree preserves code-owned source trace through pattern/signal/evidence; local human decision history is authoritative.
