...
| DEC-004 | **B2B hỗ trợ Customer Ecosystem Role.** | Người dùng, người mua và người ảnh hưởng có thể khác nhau; role có scope, nhãn và evidence, có thể unknown/nhiều role. |
...
|---|---|---|
| DEC-012 | PROPOSED | Field schema, enum signals/roles, nullable fields, định dạng snapshot/offset, lỗi contract và WriterResult trong 02–04 |
