...
SOURCE PRINCIPLE: evidence and human judgment precede creative expression; Customer Profile remains solution-independent. V2 DECISION: portable selected intelligence has immutable Zone A, PROPOSED Zone B and constrained Writer-owned Zone C. DERIVED IMPLEMENTATION RULE: copy accepted evidence exactly, record external factual requirements and prohibit validation promotion.
