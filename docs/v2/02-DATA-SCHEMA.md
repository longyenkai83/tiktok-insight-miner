...
Add v2.product-opportunities.1, v2.value-maps.1, v2.product-assumptions.1, v2.experiment-plans.1 and v2.selected-product-opportunities.1. Combined v2.product-discovery.1 and v2.product-decisions.1 preserve replay/history. See document 14 for fields, closed ID roles and evidence levels.
