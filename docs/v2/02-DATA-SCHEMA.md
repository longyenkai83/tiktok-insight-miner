...
Add canonical v2.content-intelligence-packet.1 with packet revision/supersedes, project, exact customer-truth snapshot, selected strategy, Writer permissions, external requirements, human selection and immutable lineage. Export JSON Schema to contracts/content-intelligence-packet.schema.json.
