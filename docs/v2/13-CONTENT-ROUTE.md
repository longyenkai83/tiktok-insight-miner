...
Content Route is ACCEPTED per Phase 8 request; its runtime/schema remains unchanged. Selected angle now feeds the typed packet after current-ledger validation. Rejected/deferred/unselected/stale angles cannot produce packets. No Reelo calls.
